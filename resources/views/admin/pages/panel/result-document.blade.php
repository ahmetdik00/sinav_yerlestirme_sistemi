            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('user') }}">Anasayfa</a></li>
                        <li class="breadcrumb-item active">Sonuç Belgesi</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card callout callout-info" style="background-color: #fffffc;">
                        ...
                        <a class="b" href="{{ route('sonuc-belgesi-pdf', [$student->aday_no, $resultDocument->email]) }}" style="cursor: pointer; position: absolute; top: 80px; right: 28px; padding-left: 50px; line-height: 43px; z-index: 100;">
                        ...
                        <div id="data" class="card-body d-flex flex-column align-items-center">
                            <table class="tabled table-borderedd">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">{{ $resultDocument->puan }}</td>
                                </tr>
                            </table>
                            <div class="pt-3">
                                <ol>
